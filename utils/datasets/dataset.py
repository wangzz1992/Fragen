...
class SurfLigandPairDataset(Dataset):
    ...
    def __init__(self, index_path='./data/crossdocked_pocket10/index.pkl',processed_path='./data/crossdock_data_gds.lmdb', name2id='./data/crossdocked_name2id.pt', transform=None):
        super().__init__()
